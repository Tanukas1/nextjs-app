...
const bodyServices = [
    {
        ...
        desc: "Gentle exfoliation and a nourishing massage for smooth, luminous skin.",
        img: "https://www.knksalon.in/assets-admin/upload/category_service/659688194c134.webp",
    },
    {
...
function BodyCard({ service, index }) {
    return (
            ...
            <section className="relative overflow-hidden px-6 pt-20 pb-20 md:pt-28 md:pb-24">
                ...
                <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
                    ...
                    <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-luxe border border-border">
                        <img
                            src="https://www.knksalon.in/assets-admin/upload/category_service/65e99174ede39.webp"
